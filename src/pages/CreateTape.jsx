...
export const CreateTape = () => {
  ...
  const [name, setName] = useState('My Mixtape');
  ...
  return (
    <AnimatedPage>
      <div className="text-center mb-8 pt-4">
        <h1 className="text-2xl font-pixel glow-text mb-2">CRAFT YOUR TAPE</h1>
        <p className="text-gray-500 font-mono text-xs tracking-widest">DESIGN YOUR PERFECT MIXTAPE</p>
      </div>
